    ...
    <article class="content">
      ...
      <section class="step warn">
        <ul>
          ...
          <li><strong>Horní lišta skóre:</strong> skóre je v <strong>boxu</strong>, domácí vlevo. Po stranách boxu je <strong>5 teček týmových faulů</strong> dané čtvrtiny (domácí vlevo, hosté vpravo). Postupně se rozsvěcují: <strong>1.-3. žlutě</strong>, <strong>4. a 5. červeně</strong> (varování, že se blíží bonus). Jakmile je tým v <em>bonusu</em> (5. týmový faul → soupeř střílí trestné), zčervenají <strong>všechny</strong>. Fauly se resetují každou čtvrtinu. <em>Na telefonu na výšku jsou tečky u skóre v horní (sticky) liště.</em></li>
